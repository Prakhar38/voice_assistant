...
class VoiceAssistant(CTk):
    ...
    def Assist(self):
        ...
        try:
            ...
            if self.text == "Hello Jarvis".lower():
                self.speak("Hii Sir! This is Jarvis! How can I help you?")
                print('Response: Hii Sir! This is Jarvis! How can I help you?')
                ...
                print(f"Response:Sir! It's {datetime.now().strftime("%H")} hour { datetime.now().strftime("%M")} minutes and {int(datetime.now().strftime("%S"))} seconds right now!")
                ...
                print(f"Response: Sir! IT's {datetime.now().day} {months[datetime.now().month]} {datetime.now().year} today!")
            ...
            #     self.AI() 
                ...
                print("TResponse: aking screenshot in 5 seconds")
                self.after(5000, self.Screenshot)
                self.speak("Done Sir")
                print("DResponse: one Sir")
            ...
            print('Response: Sorry! I could not understand Sir')
            if self.attempt == 3:
                self.speak("Good Bye Sir!")
                print("GResponse: ood Bye Sir!")
                self.quit()
            self.attempt += 1
        except recognize.RequestError:
            self.speak('Sorry! Currently some services are not available Sir')
            print('Response: Sorry! Currently some services are not available Sir')
            quit()
        except Exception as e:
            print(e)
    ...
    # Method to connect Jarvis to openai
    # def AI(self):
